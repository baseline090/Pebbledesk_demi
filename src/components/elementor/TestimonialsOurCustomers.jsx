...
const TestimonialsOurCustomers = () => {
  ...
  return (
    <>
      <section className="bg-[#f0f5f7] pt-[85px] pr-0 pb-[90px] pl-0 overflow-hidden">
      ...
      {/* Image Links */}
      <section className="bg-white border-b border-[#ecedf2] transition-all duration-300 pt-[40px] pb-[40px]">
          ...
          <div className="w-full">
            <div className="flex flex-wrap justify-center gap-6">
              {imageLinks.map((imgSrc, index) => (
                <div
                  key={index}
                  className="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/6 xl:w-1/8 overflow-hidden"
                >
